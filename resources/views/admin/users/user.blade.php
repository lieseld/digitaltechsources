            ...
            <div class="twelve wide column">
                ...
                <table id="table" class="ui celled table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Name</td>
                            <td class="ui editForm disabled input">
                        ...
                        <tr>
                            ...
                            <td class="ui editForm disabled input">
                                <input type="text" name="educational_institution" value="{{ $user->educational_institution }}">
                            </td>
                        </tr>
                        <tr>
                            <td>Profession</td>
                            <td>
                                <div class="editForm ui selection disabled dropdown">
                                    <input type="hidden" name="profession" value="{{ $user->profession }}">
                                    <i class="dropdown icon"></i>
                                    <div class="default text">Profession</div>
                                    <div class="menu">
                                        <div class="item" data-value="0">A student</div>
                                        <div class="item" data-value="1">A teacher</div>
                                        <div class="item" data-value="2">A professional</div>
                                        <div class="item" data-value="3">A hobbyist</div>
                                    </div>
                                </div>
                            </td>
                        </tr>
                ...
                <a href="#" onclick="editUserOn()" id="editButton" class="ui blue left icon button">
                    <i class="pencil icon"></i>
                    Edit User
                </a>
                <a href="#" onclick="saveChanges()" id="saveButton" class="ui disabled green left icon button">
                    <i class="save icon"></i>
                    Save Changes
                </a>
                </form>
                ...
                <script type="text/javascript">
                    function editUserOn() {
                        $('.editForm.ui.disabled.input').removeClass('disabled');
                        $('.editForm.ui.disabled.dropdown').removeClass('disabled');
                        $('#saveButton').html('<i class="save icon"></i>Save Changes');
                    ...
                    function saveChanges() {
                        ...
                        $.ajax({
                            ...
                            success:function(data) {
                                $('#saveButton').text('Saved').removeClass('loading').removeClass('green').addClass('green').addClass('disabled');
                                $('.editForm.ui.input').addClass('disabled');
                                $('.editForm.ui.dropdown').addClass('disabled');
